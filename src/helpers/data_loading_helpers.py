        ...
        if "rawEEG" in available_objects:
            ...
            for raw_eegs_obj, ets_obj, word_obj, ffd, gd, gpt, trt, sfd, nFix, fixPos in zipped_data:
                ...
                if is_real_word(word_string):
                    ...
                    data_dict["ALPHA_EEG"] = [key[0] for key in data_dict["ALPHA_EEG"]]
                    data_dict["BETA_EEG"] = [key[0] for key in data_dict["BETA_EEG"]]
                    data_dict["GAMMA_EEG"] = [key[0] for key in data_dict["GAMMA_EEG"]]
                    data_dict["THETA_EEG"] = [key[0] for key in data_dict["THETA_EEG"]]
